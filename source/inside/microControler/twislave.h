...
#define buffer_size 30 								//Größe der Buffer in Byte (2..254)
...
extern volatile uint8_t rxbuffer[buffer_size];				//Der Empfangsbuffer, der vom Slave ausgelesen werden kann.
extern volatile uint8_t txbuffer[buffer_size];				//Der Sendebuffe, der vom Master ausgelesen werden kann.
extern volatile uint8_t buffer_adr; 						//"Adressregister" für den Buffer
